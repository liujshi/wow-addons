...
function sArena.OptionsPanel:Initialize()
	local Title, SubTitle = LibStub("tekKonfig-Heading").new(self, sArena.AddonName, L["Enhanced arena frames"])
	...
	LockButton:SetText(sArenaDB.lock and L["Unlock"] or L["Lock"])
	...
	ScaleText:SetText(L["Frame Scale: "])
	...
	CastingBarScaleText:SetText(L["Casting Bar Scale: "])
	...
	StatusTextSizeText:SetText(L["Status Text Size: "])
	...
	local GrowUpwardsCheckbox = LibStub("tekKonfig-Checkbox").new(self, nil, L["Grow Upwards"], "TOPLEFT", ScaleText, "BOTTOMLEFT", 0, -10)
	...
	local FlipCastingBarCheckbox = LibStub("tekKonfig-Checkbox").new(self, nil, L["Flip Casting Bars"], "LEFT", GrowUpwardsCheckbox, "RIGHT", 100, 0)
	...
	local ClassColoursFrame = LibStub("tekKonfig-Group").new(self, L["Class Colours"], "TOPLEFT", GrowUpwardsCheckbox, "BOTTOMLEFT", 0, -18)
	ClassColoursFrame:SetPoint("RIGHT", self, -16, 0)
	ClassColoursFrame:SetHeight(40)
	ClassColoursFrame:SetFrameLevel(3)
	
	local ClassColoursHealthbarCheckbox = LibStub("tekKonfig-Checkbox").new(self, nil, L["Health Bar"], "TOPLEFT", ClassColoursFrame, 8, -8)
	...
	local ClassColoursNameCheckbox = LibStub("tekKonfig-Checkbox").new(self, nil, L["Name"], "LEFT", ClassColoursHealthbarCheckbox, "RIGHT", 72, 0)
	...
	local ClassColoursFrameCheckbox = LibStub("tekKonfig-Checkbox").new(self, nil, L["Frame"], "LEFT", ClassColoursNameCheckbox, "RIGHT", 45, 0)
	...
	local TrinketsFrame = LibStub("tekKonfig-Group").new(self, L["Trinkets"], "TOPLEFT", ClassColoursFrame, "BOTTOMLEFT", 0, -16)
	TrinketsFrame:SetPoint("RIGHT", self, -16, 0)
	TrinketsFrame:SetHeight(80)
	TrinketsFrame:SetFrameLevel(3)
	
	local TrinketsEnableCheckbox = LibStub("tekKonfig-Checkbox").new(self, nil, L["Enable"], "TOPLEFT", TrinketsFrame, 8, -8)
	...
	local TrinketsAlwaysShowCheckbox = LibStub("tekKonfig-Checkbox").new(self, nil, L["Always Show"], "LEFT", TrinketsEnableCheckbox, "RIGHT", 45, 0)
	...
	TrinketsIconScaleText:SetText(L["Icon Scale: "])
